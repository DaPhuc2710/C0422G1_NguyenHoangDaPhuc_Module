...
public class Contract {
    ...
    public Contract(Integer contractId, String beginDate, String endDate, Double deposit, Employee employee, Customer customer, Facility facility, List<DetailContract> detailContracts) {
        this.contractId = contractId;
        this.beginDate = beginDate;
        this.endDate = endDate;
        this.deposit = deposit;
    ...
    public Contract(String beginDate, String endDate, Double deposit, Employee employee, Customer customer, Facility facility, List<DetailContract> detailContracts) {
        this.beginDate = beginDate;
        this.endDate = endDate;
        this.deposit = deposit;
        this.employee = employee;
